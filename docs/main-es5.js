...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function sharedStoreInterfacesTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "htmlGithubApi", function () {
      return htmlGithubApi;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "githubAuthorizationHeader", function () {
      return githubAuthorizationHeader;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "rawDataFile", function () {
      return rawDataFile;
    });

    var token = '69932e14f25f7a587af6c8ff520edb95afd9dffa';
    var htmlGithubApi = 'https://api.github.com/repos/auxilien0/countenergy';
    var githubAuthorizationHeader = {
      headers: {
        Authorization: "token ".concat(token)
      }
    };

    var rawDataFile = function rawDataFile(filePath) {
      var x = "".concat(htmlGithubApi, "/contents/").concat(filePath);
      console.log('x :>> ', x);
      return x;
    };
    /***/
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _search_result_search_result_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./search-result/search-result.component */
    "./src/app/search-result/search-result.component.ts"); // tslint:disable:max-line-length
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_store_list_list_actions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! src/store/list/list.actions */
    "./src/store/list/list.actions.ts");
    /* harmony import */


    var shared_store_interfaces__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    var AppComponent = /*#__PURE__*/function () {
      ...
      _createClass(AppComponent, [{
        ...
        value: function getUrl(url) {
          return this.http.get("".concat(shared_store_interfaces__WEBPACK_IMPORTED_MODULE_2__["htmlGithubApi"]).concat(url));
        }
      }, {
        key: "ngOnInit",
        value: function ngOnInit() {
          ...
          this.loading = true;
          this.getUrl('/git/trees/master?recursive=1').subscribe(function (data) {
            var customers = data.tree.filter(function (tree) {
              return tree.path.split('/').length > 2;
            }).map(function (tree) {
              var path = tree.path.split('/');
              return {
                slug: path[2],
                name: path[2].replace(/csvs-parts-/gi, '').replace(/-/gi, ' ')
              };
            });
            _this.customers = customers.filter(function (thing, index, self) {
              return index === self.findIndex(function (t) {
                return t.slug === thing.slug;
              });
            });

            _this.store.dispatch(new src_store_list_list_actions__WEBPACK_IMPORTED_MODULE_1__["AddListItem"](data.tree));
    ...
    AppComponent.ɵfac = function AppComponent_Factory(t) {
      return new (t || AppComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ngxs_store__WEBPACK_IMPORTED_MODULE_4__["Store"]));
    };
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 2,
      vars: 1,
      consts: [[4, "ngIf"], ["class", "navA", 3, "routerLink", 4, "ngFor", "ngForOf"], [1, "navA", 3, "routerLink"]],
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_5__["NgIf"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["RouterOutlet"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgForOf"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["RouterLinkWithHref"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _store_list_list_effect__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    var _scullyio_ng_lib__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(
    /*! @scullyio/ng-lib */
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_common_http__WEBPACK_IMPORTED_MODULE_25__["HttpClientModule"], _angular_material_card__WEBPACK_IMPORTED_MODULE_12__["MatCardModule"], _angular_material_toolbar__WEBPACK_IMPORTED_MODULE_13__["MatToolbarModule"], _angular_material_icon__WEBPACK_IMPORTED_MODULE_14__["MatIconModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_15__["MatButtonModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_17__["MatSelectModule"], _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_18__["MatCheckboxModule"], _angular_material_tooltip__WEBPACK_IMPORTED_MODULE_11__["MatTooltipModule"], _angular_material_dialog__WEBPACK_IMPORTED_MODULE_19__["MatDialogModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_23__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_23__["FormsModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_20__["MatFormFieldModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_21__["MatTableModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_16__["MatInputModule"], _angular_material_radio__WEBPACK_IMPORTED_MODULE_22__["MatRadioModule"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_4__["BrowserAnimationsModule"], _ngxs_store__WEBPACK_IMPORTED_MODULE_5__["NgxsModule"].forRoot([_store_list_list_effect__WEBPACK_IMPORTED_MODULE_7__["ListState"]]), _angular_flex_layout__WEBPACK_IMPORTED_MODULE_9__["FlexLayoutModule"], _ngxs_devtools_plugin__WEBPACK_IMPORTED_MODULE_6__["NgxsReduxDevtoolsPluginModule"].forRoot(), _angular_common_http__WEBPACK_IMPORTED_MODULE_25__["HttpClientXsrfModule"].withOptions({
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _search_result_search_result_component__WEBPACK_IMPORTED_MODULE_8__["SearchResultComponent"], _spinner_spinner_component__WEBPACK_IMPORTED_MODULE_10__["SpinnerComponent"], _home_home_component__WEBPACK_IMPORTED_MODULE_24__["HomeComponent"]],
  ...
  function srcAppSearchResultSearchResultComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_store_interfaces__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../../../shared/store.interfaces */
    "./shared/store.interfaces.ts");
    /* harmony import */
    ...
    function SearchResultComponent_p_3_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function SearchResultComponent_p_4_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var SearchResultComponent = /*#__PURE__*/function () {
      function SearchResultComponent(activeRoute, http) {
      ...
      _createClass(SearchResultComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.listItemsSubscribe.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.destroy)).subscribe(function (res) {
            if (!!res) {
              _this2.activeRouteSubscribtion = _this2.activeRoute.url.subscribe(function (url) {
                _this2.listIndes = 0;
                _this2.errorNoMore = '';
                _this2.data = '';

                if (url.length && !(typeof url[1] === 'undefined')) {
                  _this2.listItems = res.filter(function (item) {
                    return item.path.indexOf(url[1].path) !== -1 && item.path.endsWith('csv');
                  });

                  if (_this2.listItems.length) {
                    console.log('this.listItems[this.listIndes].path :>> ', _this2.listItems[_this2.listIndes].path);

                    _this2.showDocument(_this2.listItems[_this2.listIndes].path);
                  }
                }
              });
            }
        ...
        key: "showDocument",
        value: function showDocument(path) {
          var _this3 = this;
          ...
          this.http.get(Object(_shared_store_interfaces__WEBPACK_IMPORTED_MODULE_5__["rawDataFile"])(path), {
            ...
            _this3.listIndes = _this3.listIndes + 1;
    ...
    SearchResultComponent.ɵfac = function SearchResultComponent_Factory(t) {
      return new (t || SearchResultComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_7__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_8__["HttpClient"]));
    };
    ...
    SearchResultComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      decls: 5,
      vars: 3,
      consts: [[1, "container", 3, "scroll"], [1, "data"], [4, "ngIf"], ["class", "no_more_data", 4, "ngIf"], [1, "no_more_data"]],
      template: function SearchResultComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 0);

          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("scroll", function SearchResultComponent_Template_div_scroll_0_listener($event) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /media/jan/2CDE0B17DE0AD94A/PROJECT/angular/jindra/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
